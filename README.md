...
Search engine for lyrics and shows some of the information of the band.
The data consumption is done through two API's and the requests are executed with axios.
